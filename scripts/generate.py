...
def main() -> None:
    ...
    export_parser.add_argument("--node-list", default="data/React/node_list.json")
    export_parser.add_argument("--node-dependency", default="data/React/node_dependency.json")
    ...
    submit_parser.add_argument("--node-list", default="data/React/node_list.json")
    submit_parser.add_argument("--node-dependency", default="data/React/node_dependency.json")
